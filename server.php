...
require('../../config.php');
require_once("$CFG->dirroot/webservice/soapfda/locallib.php");

if (!webservice_protocol_is_enabled('soapfda')) {
    debugging('The server died because the web services or the SOAPFDA protocol are not enable',
        DEBUG_DEVELOPER);
    die;
}
